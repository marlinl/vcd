class Vcd < Formula
  ...
  homepage "https://github.com/vcd/vcd"
  url "https://github.com/vcd/vcd/releases/download/v0.1.0/vcd-aarch64-apple-darwin.tar.gz"
  sha256 "REPLACE_WITH_RELEASE_TARBALL_SHA256"
  license "Apache-2.0"
  head "https://github.com/vcd/vcd.git", branch: "master"
